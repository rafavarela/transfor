	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-default">
				<div class="panel-heading">Secciones del CMS</div>

				<div class="panel-body">
				    <p>
                        <a class="btn btn-info" href="{{ route('admin.cmsseccion.create') }}" role="button">Nueva sección</a>
				    </p>
				    <p>{{ $cmssecciones->total() }} Secciones. Página {{ $cmssecciones->currentPage() }} de {{ $cmssecciones->lastPage() }}</p>
					@include('admin.cmssecciones.partials.table')
                    {!! $cmssecciones->render() !!}
				</div>
			</div>
		</div>
