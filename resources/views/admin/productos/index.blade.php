        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <p>
                        <a class="btn btn-info" href="{{ route('admin.producto.create') }}" role="button">Nuevo producto</a>
                        <a class="btn btn-info" href="{{ route('admin.categoria.index') }}" role="button">Ir al listado de Categorías</a>
                    </p>
                    <p>{{ $productos->total() }} Productos. Página {{ $productos->currentPage() }} de {{ $productos->lastPage() }}</p>
